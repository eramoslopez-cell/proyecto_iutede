...
class BaseRepository:
    ...
    def get_all(self, skip: int = 0, limit: int =100)->List:
        ...
        #offset: salta los primeros N registros, util para la paginacion de datos
        #limit: devuelve como maximo N registros
        
    def get_by_id(self, record_id: int) ->Optional: #si no encuentra el id buscado retorna None
